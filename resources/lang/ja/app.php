...
return [
    ...
    */
    ...
    'sentence' => [
        'auth' => [
            'login' => 'お使いのSNSアカウントを使って登録・ログインができます。',
            'register' => [
        ...
        'home' => [
            'guest' => [
                ...
                '2' => '3900件以上のアニメから観たいアニメを見つけて、評価して、共有しよう。',
            ],
            'auth' => [
                '1' => 'Animaでは、見たアニメのレビューを投稿したり、レビューを投稿している',
                '2' => '他のユーザーをフォローすることで、タイムラインが作成されます。',
                '3' => 'まずは見たアニメのレビューを投稿するか、気になる他のユーザーをフォローしてみましょう！',
            ]
        ]
    ],
    'button' => [
