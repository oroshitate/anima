...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-10 col-md-8 my-5">
            ...
            <div class="box-social-twitter my-3 col-12 rounded mx-auto">
            ...
            <div class="box-social-facebook my-3 col-12 rounded mx-auto">
            ...
            <div class="box-social-google my-3 border border-secondary col-12 rounded mx-auto">
